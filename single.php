...
<head>
	<title>Look Fashion Category Bootstrap Responsive Web Template | Single Page :: weevaa</title>
	<!-- Meta tag Keywords -->
	...
	<div class="main-banner-wvl-2">
		...
		<header>
			<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
				...
				<button class="navbar-toggler" type="button" data-toggle="collapse" data-target=".navbar-toggle" aria-controls="navbarWeevaa"
				...
				<div class="collapse navbar-collapse navbar-toggle " id="navbarWeevaa">
					<ul class="navbar-nav mx-lg-auto">
						...
						<li class="nav-item dropdown  active">
							...
							<div class="dropdown-menu second mt-2" style="display: none;">
								<a class="dropdown-item" href="index.php">Top Models</a>
								<a class="dropdown-item" href="index.php">Plans</a>
								<a class="dropdown-item" href="about.php">Our Designers</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="blog.php">Blog Page</a>
								<a class="dropdown-item active" href="single.php">Single Page</a>
							</div>
						</li>
						<li>
					...
					<div class="header-social-wvls text-center mt-lg-0 mt-4">
			...
			<div class="row footer-top">
				<div class="col-lg-5 footer-grid-wthree">
					...
					<div class="contact-info">
						...
						<p>8088 k 4th block building, Honey Avenue, <span>New York City.</span></p>
				...
				<div class="col-lg-4 footer-grid-wthree mt-lg-0 mt-5">
					...
					<p class="copy-right text-center mt-4">&copy; 2018 Look. All Rights Reserved | Design by
