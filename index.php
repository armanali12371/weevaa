...
<div class="models-agile py-5">
	<div class="container py-xl-5 py-lg-3">
		<div class="row">
			...
			<div class="col-xl-12 col-md-6 left-models mt-lg-5 mt-3 pt-lg-4">
				<!-- heading title -->
												...
												<div class="price-inner card box-shadow">
													...
													<div class="card-body">
														...
														<div class="log-in mt-md-3 mt-2">
															<a class="btn text-uppercase" href="single.php">
																Read More</a>
														</div>
													</div>
												</div>
...
<!-- <section class="pricing py-5" id="pricing">
	<div class="container">
		<h3 style="" data-fontsize="20" data-lineheight="24px" class="title-wthree text-center mb-sm-5 mb-4">Trusted
			by</h3>
		<div class="row">
			<div class="col-md-2">
				<img class="thumbnail img-responsive" style="width: 150px; height: 100px;" src="images/zara.png" />
			</div>
			<div class="col-md-2">
				<img class="thumbnail img-responsive" style="width: 150px; height: 100px;" src="images/ben.png" />
			</div>
			<div class="col-md-2">
				<img class="thumbnail img-responsive" style="width: 150px; height: 100px;" src="images/hm-logo.png" />
			</div>
			<div class="col-md-2">
				<img class="thumbnail img-responsive" style="width: 150px; height: 100px;" src="images/zara.png" />
			</div>
			...
			<div class="col-md-2">
				<img class="thumbnail img-responsive" style="width: 150px; height: 100px;" src="images/gucci_PNG28.png" />
			</div>
		</div>
	</div>
</section> -->
		...
		<div class="container py-xl-5 py-md-3">
			<div class="row">
				...
				<div class="col-xl-5 left-models pl-xl-5 mt-xl-0 mt-sm-5 mt-4">
					...
					<div class="">
						<h3 class="title-wthree mb-3"><span class="mt-2 text-uppercase font-weight-bold">Upto 40%
								Off</span></h3>
						<p class="">Sed semper leo metus, a lacinia eros semper at sed do eiusmod tempor incididunt ut.
						</p>
	...
	<div class="container py-xl-5 py-lg-3">
		...
		<div class="row contact-form py-3">
			...
			<div class="col-lg-6 map text-center">
				...
				<img src="images/pexels-los-muertos-crew-7205816.jpg" alt="" class="img-fluid" style="" />
			</div>
			<!-- //contact map -->
			<!-- contact form -->
				...
				<div class="contact-top1">
					<form action="email.php" method="post" class="f-color">
						...
						<div class="form-group">
							...
							<textarea class="contact-formwvls form-control" rows="5" name="msg" id="contactcomment" required></textarea>
						</div>
